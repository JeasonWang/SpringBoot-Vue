            ...
            <transition name="slide-fade">
                <div v-show="showAdvanceSearchView"
                    ...
                    <el-row>
                        <el-col :span="5">
                            政治面貌:
                            <el-select v-model="searchValue.politicId" clearable placeholder="政治面貌" size="mini"
                                       style="width: 130px;">
                                <el-option
                        ...
                        <el-col :span="4">
                            民族:
                            <el-select v-model="searchValue.nationId" clearable placeholder="民族" size="mini"
                                       style="width: 130px;">
                                <el-option
                        ...
                        <el-col :span="4">
                            职位:
                            <el-select v-model="searchValue.posId" placeholder="职位" clearable size="mini" style="width: 130px;">
                                <el-option
                        ...
                        <el-col :span="4">
                            职称:
                            <el-select v-model="searchValue.jobLevelId" clearable placeholder="职称" size="mini"
                                       style="width: 130px;">
                                <el-option
